...
import { X, Check, ArrowRight, MessageCircle, Sparkles } from "lucide-react";
...
export function QuoteCalculator({ open, onClose }: Props) {
  ...
  const waMessage = useMemo(() => {
    ...
    return msg;
  }, [projectType, selectedModules, selectedExtras, total]);
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-3 md:p-6" role="dialog" aria-modal="true">
      ...
      >
        ...
        {/* Body */}
        <div className="flex-1 overflow-y-auto px-5 md:px-8 py-6 grid lg:grid-cols-[1fr_320px] gap-6 lg:gap-8">
                ...
                {modules.map((m) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span
                        className="text-[10px] md:text-xs font-semibold flex-shrink-0"
                        style={{ color: "#00C2FF", fontFamily: "'JetBrains Mono', monospace" }}
                      >
                        +{formatPrice(m.price)}
                      </span>
          ...
          <aside className="lg:sticky lg:top-0 h-fit">
            <div
              ...
              style={{ background: "rgba(0,0,0,0.35)", borderColor: "rgba(0,102,255,0.3)" }}
            >
              <div
              ...
              <a
                ...
                className="group flex items-center justify-center gap-2 w-full py-4 rounded-xl font-semibold text-white transition-all duration-300 hover:-translate-y-0.5"
                style={{
              ...
              <a
                href={mailLink}
                className="mt-3 flex items-center justify-center gap-2 w-full py-3 rounded-xl text-sm font-medium border transition-colors hover:bg-white/5"
