        ...
        <div className="mt-16 grid lg:grid-cols-2 gap-6">
          {solutions.map((s, i) => (
            <Reveal key={s.title} delay={i * 120}>
              <div
                className="group relative h-full p-8 md:p-10 rounded-3xl border overflow-hidden transition-all duration-500 hover:-translate-y-1"
                style={{
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background: `radial-gradient(700px circle at 50% 0%, ${s.accent}22, transparent 45%)`,
                  }}
                />

                <div className="relative">
                  {/* Header: icono grande + tag */}
                  ...
                  <ul className="space-y-3 mb-9">
                    {s.bullets.map((b) => (
                      <li key={b} className="flex items-start gap-3">
                        ...
                        <span className="text-sm leading-relaxed" style={{ color: "#C4CCDB" }}>
                          {b}
                        </span>
                      </li>
                    ))}
                  ...
                  {/* Fila de mini iconos secundarios */}
